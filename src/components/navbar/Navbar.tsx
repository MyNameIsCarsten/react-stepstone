      ...
      <Wrapper>
        ...
        <LinksWrapper>
            ...
            <StyledLink>
                ...
                <PopUp $depth="160px">
                    <PopUpSpan>Aktuell</PopUpSpan>
                    <PopUpSpan>Gehalt</PopUpSpan>
                    <PopUpSpan>Karriere</PopUpSpan>
                    <PopUpSpan>Berufsleben</PopUpSpan>
                </PopUp>
            </StyledLink>
            <StyledLink>
                <PopUpTrigger>
                    <StyledSvg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 20 20" aria-labelledby="StudyOwlIcon-1174"><title id="StudyOwlIcon-1174">Study owl icon</title><path fill="currentColor" d="M6.958 5.458V4.083c0-.444.153-.819.459-1.125A1.53 1.53 0 018.542 2.5h2.916c.445 0 .82.153 1.125.458.306.306.459.681.459 1.125v1.375h3.291c.445 0 .82.153 1.125.459.306.305.459.68.459 1.125V15.5c0 .445-.153.82-.459 1.125a1.53 1.53 0 01-1.125.458H3.667a1.53 1.53 0 01-1.125-.458 1.528 1.528 0 01-.459-1.125V7.042c0-.445.153-.82.459-1.125.305-.306.68-.459 1.125-.459h3.291zm1.334 0h3.416V4.083c0-.055-.028-.11-.083-.166-.055-.056-.111-.084-.167-.084H8.542c-.056 0-.112.028-.167.084-.055.055-.083.11-.083.166v1.375zm8.291 6.896h-4.416v.708a.76.76 0 01-.24.553.782.782 0 01-.573.239H8.646a.782.782 0 01-.573-.239.76.76 0 01-.24-.553v-.708H3.417V15.5c0 .055.028.111.083.167.055.055.111.083.167.083h12.666c.056 0 .112-.028.167-.083.055-.056.083-.112.083-.167v-3.146zm-7.416.167h1.666v-1.667H9.167v1.667zm-5.75-1.5h4.416v-.709c0-.208.08-.392.24-.552a.78.78 0 01.573-.239h2.708c.223 0 .414.08.573.239.16.16.24.344.24.552v.709h4.416V7.042c0-.056-.028-.112-.083-.167-.055-.055-.111-.083-.167-.083H3.667c-.056 0-.112.028-.167.083-.055.055-.083.111-.083.167v3.979z"></path></StyledSvg>
                    Meine Karriere
                </PopUpTrigger>
                <PopUp $depth="160px">
                    <PopUpSpan>Lebenslauf erstellen</PopUpSpan>
                    <PopUpSpan>Beste Arbeitgeber</PopUpSpan>
                    <PopUpSpan>Gehaltsplaner</PopUpSpan>
                    <PopUpSpan>Anschreiben erstellen</PopUpSpan>
                </PopUp>
            </StyledLink>
            <StyledLink>
                <PopUpTrigger>
                    <StyledSvg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 20 20" aria-labelledby="HeartEmptyIcon-1179"><title id="HeartEmptyIcon-1179">Heart empty icon</title><path fill="currentColor" d="M8.938 15.979l-1.042-.958c-1.57-1.403-2.93-2.75-4.084-4.042-1.153-1.291-1.729-2.68-1.729-4.167 0-1.18.403-2.176 1.209-2.989.805-.813 1.805-1.219 3-1.219.68 0 1.343.156 1.989.469C8.927 3.386 9.5 3.861 10 4.5c.486-.639 1.052-1.114 1.698-1.427a4.52 4.52 0 011.99-.469c1.194 0 2.197.406 3.01 1.219.813.813 1.219 1.809 1.219 2.989 0 1.5-.6 2.906-1.802 4.219a66.748 66.748 0 01-4.198 4.157l-.855.77a1.49 1.49 0 01-1.062.407 1.677 1.677 0 01-1.062-.386zm.416-10.187c-.277-.514-.697-.952-1.26-1.313a3.281 3.281 0 00-1.802-.541c-.833 0-1.521.27-2.063.812-.541.541-.812 1.229-.812 2.062 0 .667.212 1.358.635 2.073.424.715.959 1.424 1.604 2.125.646.701 1.34 1.385 2.084 2.052.743.667 1.44 1.306 2.093 1.917a.226.226 0 00.167.063c.07 0 .125-.021.167-.063.639-.583 1.333-1.215 2.083-1.896.75-.68 1.444-1.378 2.083-2.093a14.628 14.628 0 001.605-2.136c.43-.708.645-1.389.645-2.042 0-.833-.274-1.52-.823-2.062-.548-.541-1.239-.812-2.072-.812-.64 0-1.23.18-1.771.541a3.87 3.87 0 00-1.25 1.313.801.801 0 01-.292.271.765.765 0 01-.375.104.732.732 0 01-.354-.104.791.791 0 01-.292-.271z"></path></StyledSvg>
                    Meine Jobs
                </PopUpTrigger>
                <PopUp $depth="133px">
                    <PopUpSpan>Mein Stepstone</PopUpSpan>
                    <PopUpSpan>Gespeicherte Jobs</PopUpSpan>
                    <PopUpSpan>Bewerbungen</PopUpSpan>
                </PopUp>
            </StyledLink>
            <StyledLink $mobile={true}>
                <UserInitial>C</UserInitial>
                <PopUpTrigger>Carsten</PopUpTrigger>
                <PopUp $depth="160px" $length="-100px">
                    <PopUpSpan>Mein Profil</PopUpSpan>
                    <PopUpSpan>Kontoeinstellungen</PopUpSpan>
                    <PopUpSpan>Job-Benachrichtigungen</PopUpSpan>
                    <PopUpSpan>Nicht Carsten? Ausloggen</PopUpSpan>
                </PopUp>
            </StyledLink>
